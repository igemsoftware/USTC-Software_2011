...
const char * LIB_PATH_VALUE   = "d:\\igame\\git\\lachesis\\lib\\gsl-1.15\\gsl-1.15\\.libs;d:\\igame\\git\\lachesis\\lib\\gsl-1.15\\gsl-1.15\\cblas\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "d:\\igame\\git\\lachesis\\lib\\gsl-1.15\\gsl-1.15\\.libs;d:\\igame\\git\\lachesis\\lib\\gsl-1.15\\gsl-1.15\\cblas\\.libs;d:\\qt\\mingw\\lib;d:\\qt\\mingw\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' libgsl.la /d/igame/git/lachesis/lib/gsl-1.15/gsl-1.15/cblas/libgslcblas.la cblas/libgslcblas.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"gsl-histogram.exe:gsl-histogram:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gsl-histogram.exe:gsl-histogram:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gsl-histogram.exe:gsl-histogram:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/d/igame/git/lachesis/lib/gsl-1.15/gsl-1.15/.libs:/d/igame/git/lachesis/lib/gsl-1.15/gsl-1.15/cblas/.libs:/mingw/lib:/mingw/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/igame/git/lachesis/lib/gsl-1.15/gsl-1.15/.libs:/d/igame/git/lachesis/lib/gsl-1.15/gsl-1.15/cblas/.libs:$PATH\"\n", f);
  fputs ("\n", f);
