...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"gsl-randist.exe:gsl-randist:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"gsl-randist.exe:gsl-randist:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"gsl-randist.exe:gsl-randist:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
