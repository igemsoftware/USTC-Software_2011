...
// Generate Time: Fri Jul 22 00:57:32 2011
...
bool RSBPMLParser::parse(DesignerModelItf* model, QDomDocument& doc)
{
	...
	while(curTask<(size_t)taskList.size())
	{
		...
		case 3:   //#object$markAsModel$standardObject$appendToArray^
			{
					...
					!childElem.isNull(); childElem = childElem.nextSiblingElement())
				{
					...
					else if(childElem.nodeName()=="twin")
					{
		...
		case 43:   //
			...
			break;
		case 44:   //#value$setProperty$appendToArray^
			{
				//setProperty
				QScriptValue newItemValue;
				newItemValue = QScriptValue(taskList[curTask].taskElem.text());
			...
			break;
		case 45:   //#value^/*partsregistry.org*/samples
			{
				//defaultAction
				//setProperty
				QScriptValue newItemValue;
			...
			break;
		case 46:   //#value^/*partsregistry.org*/references
			{
				//defaultAction
				//setProperty
				QScriptValue newItemValue;
			...
			break;
		case 47:   //#value^/*partsregistry.org*/groups
			{
				//defaultAction
				//setProperty
				QScriptValue newItemValue;
